$(document).ready(function () {
  ...
  function carregarHorarios() {
      $.get('http://agendamentosmanicure.onrender.com/api/horarios', function (data) {
  ...
  $('#agendar-form').on('submit', function (event) {
      ...
      $.ajax({
          url: 'http://agendamentosmanicure.onrender.com/api/agendar',
          method: 'POST',
  ...
  function cancelarAgendamento(horario, data) {
      $.ajax({
          url: `http://agendamentosmanicure.onrender.com/api/cancelar?horario=${encodeURIComponent(horario)}&data=${encodeURIComponent(data)}`,
          method: 'DELETE',
          success: function (response) {
              $('#notification').text(response.message).removeClass('hide').addClass('show');
              setTimeout(function () {
