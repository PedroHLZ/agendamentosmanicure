$(document).ready(function () {
    ...
    function carregarHorarios() {
        $.get('http://localhost:3000/api/horarios', function (data) {
            ...
            const hoje = new Date();  // Não alterar a hora aqui
            ...
            agendamentos.forEach(agendamento => {
                ...
                dataAgendamento.setHours(24, 0, 0, 0); // Definir hora do dia para 00:00

                if (!isNaN(dataAgendamento.getTime())) {
                    const diaSemana = diasSemana[dataAgendamento.getDay()]; // Mantendo o cálculo correto aqui
